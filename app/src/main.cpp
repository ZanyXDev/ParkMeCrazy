...
*/
    ...
    if (  myappTranslator.load(QLocale(), QLatin1String("parkmecrazy"), QLatin1String("_"), QLatin1String(":/res/i18n")) ){
 ...
 *
 */
    qmlRegisterSingletonInstance("io.github.zanyxdev.parkmecrazy.hal", 1, 0,"HAL", hal.get());
    engine.load(url);
